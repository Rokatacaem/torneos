            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-4 items-center">
                    ...
                    <a
                        ...
                        className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-md font-bold text-sm shadow-md transition-all active:scale-95"
                    >
